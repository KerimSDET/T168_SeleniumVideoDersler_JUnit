...
public class C05_AssertionsClassWork {
    ...
    @Test
    public void test1() { //Url Test   //	○ Sayfa URL’inin https://www.bestbuy.com/ ‘a esit oldugunu test edin
    ...
    @Test
    public void test2() { //title test // ○ titleTest => Sayfa başlığının “Rest” içermediğini(contains) test edin
    ...
    @Test
    public void test3() {  //logotest //	○ logoTest => BestBuy logosunun görüntülendigini test edin
    ...
    @Test
    public void test4() { //linktest  //	○ FrancaisLinkTest => Fransizca Linkin görüntülendiğini test edin
