package tests.K18_WebTables.D02_KlasikHtmlOlmayanTables;
...
public class C01_KlasikHtmlOlmayanTablo extends TestBase_Each {
    ...
    public void test01() {
        ...
        //Klavuz :      //*[@role='trow'][4]/*[@role='tdata'][1]

        //  1. “https://testotomasyonu.com/webtables2” sayfasina gidin
        driver.get("https://testotomasyonu.com/webtables2");

        //  2. Headers da bulunan basliklari yazdirin
        List<WebElement> baslikElementleriListesi = driver.findElements(By.xpath("//*[@role='hrow']/*[@role='hdata']"));

        System.out.println("Basliklar : " + ReuseableMethods.stringListeDondur(baslikElementleriListesi));
        ...
        System.out.println("Tablodaki tum datalar : " + ReuseableMethods.stringListeDondur(tumDataListesi));
